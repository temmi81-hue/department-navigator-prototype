...
export default function Home() {
  ...
  return <main>
    ...
    {!searched && <section className="hero"><p className="eyebrow">상황 기반 부서 안내</p><h1>어떤 업무를<br />준비하고 계신가요?</h1><p className="lead">업무 상황을 입력하면 협의할 부서 후보와 근거를 안내합니다.</p>
